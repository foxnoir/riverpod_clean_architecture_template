...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i946.AuthRemoteDataSource>(
        () => _i946.AuthRemoteDataSourceImpl(gh<_i519.Client>()));
    ...
    gh.lazySingleton<_i1060.AuthRepository>(
        () => _i874.AuthRepoImpl(gh<_i946.AuthRemoteDataSource>()));
    gh.factory<_i885.GetUsers>(
        () => _i885.GetUsers(gh<_i1060.AuthRepository>()));
    gh.factory<_i623.CreateUser>(
